(function(g){var window=this;var gAa=function(a,b){var c=[];g.ui(b,function(a){try{var b=g.GD.prototype.o.call(this,a,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}g.sa(b)?g.FD(b)&&c.push(a):c.push(a)},a);
...
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;R7("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",Q7,c)}},mAa=function(){if(T7("CriOS")){var a=window.__gCrWeb&&window.__gCrWeb.message&&window.__gCrWeb.message.invokeOnHost;
if(a){lAa();a({command:"cast.sender.init"});return}}if(!window.chrome||T7("Edge"))Q7();else if(lAa(),T7("Android")&&T7("Chrome/")&&window.navigator.presentation){a="";var b=g.Oh();55<=b?a="55":50<=b&&(a="50");R7("//www.gstatic.com/eureka/clank"+a+g.Osa,Q7)}else S7(0)},nAa=function(a){g.TG[a]&&(a=g.TG[a],(0,g.F)(a,function(a){g.RG[a]&&delete g.RG[a]}),a.length=0)},oAa=function(a){var b=g.QG();
...
g.Xc(a,"https://www.gstatic.com/cv/js/sender/v1/cast_sender.js");a=a.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+g.$a(a)},sAa=function(a,b){var c=g.Bd("SCRIPT");
...
g.Yc(c,g.ae("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"));var d=window.document.getElementsByTagName("head")[0]||window.document.body;d.insertBefore(c,d.firstChild);return c},tAa=function(){var a=rAa(),b=window.document.getElementById(a),c=b&&g.fG(b,"loaded");
...
c(!1))},d?window.spf?window.spf.script.load("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js","",void 0):tAa():mAa())):U7("Cannot initialize because not running Chrome")},e8=function(a,b){g.HG.call(this);
this.g=0;this.B=a;this.D=[];this.C=new g.UB;this.A=this.o=null;this.I=(0,g.y)(this.iO,this);this.F=(0,g.y)(this.ol,this);this.G=(0,g.y)(this.hO,this);this.J=(0,g.y)(this.vO,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.mu,this),EAa(this))):c=3;0!=c&&(b?this.mu(c):g.dF((0,g.y)(function(){this.mu(c)},this),0));
var d=AAa();d&&d8(this,d);this.subscribe("yt-remote-cast2-session-change",this.J)},f8=function(a){return new g.XI(a.B.getPlayerContextData())},EAa=function(a){(0,g.F)("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange".split(" "),function(a){this.D.push(this.B.subscribe(a,g.Ea(this.zQ,a),this))},a)},FAa=function(a){(0,g.F)(a.D,function(a){this.B.unsubscribeByKey(a)},a);
...
a.B.setPlayerContextData(g.cJ(b));EAa(a)},d8=function(a,b){a.A&&(a.A.removeUpdateListener(a.I),a.A.removeMediaListener(a.F),a.ol(null));
a.A=b;a.A&&(k8("Setting cast session: "+a.A.sessionId),a.A.addUpdateListener(a.I),a.A.addMediaListener(a.F),a.A.media.length&&a.ol(a.A.media[0]))},GAa=function(a){var b=a.o.media,c=a.o.customData;
...
this.F=a;this.R=b;this.o=new g.EG(this);g.M(this,this.o);this.o.P(b,"onCaptionsTrackListChanged",this.yP);this.o.P(b,"captionschanged",this.gO);this.o.P(b,"captionssettingschanged",this.pC);this.o.P(b,"videoplayerreset",this.qo);this.o.P(b,"mdxautoplaycancel",this.FG);this.O=this.o.P(b,"onVolumeChange",this.IA);this.D=!1;this.g=c;c.subscribe("proxyStateChange",this.VA,this);c.subscribe("remotePlayerChange",this.ql,this);c.subscribe("remoteQueueChange",this.qo,this);c.subscribe("autoplayUpNext",this.uA,
this);c.subscribe("previousNextChange",this.SA,this);c.subscribe("nowAutoplaying",this.KA,this);c.subscribe("autoplayDismissed",this.tA,this);this.suggestion=null;this.G=new g.mR(64);this.A=new g.It(this.kC,500,this);g.M(this,this.A);this.B=new g.It(this.lC,1E3,this);g.M(this,this.B);this.J=new E8(this.qT,0,this);g.M(this,this.J);this.C={};this.L=new g.It(this.NC,1E3,this);g.M(this,this.L);this.I=new g.Dk(this.TK,1E3,this);g.M(this,this.I);this.N=g.x;this.pC();this.qo();this.ql()},G8=function(a,b){var c=
...
b&&(c={style:a.R.ni()},g.ec(c,b));a.g.cC(a.R.ga(1).videoId,c);a.C=f8(a.g).o}},K8=function(a,b){var c=a.R.Rf();
if(c){var d=c.ae();var e=c.listId.toString()}var f=a.R.ga(1);c=a.g;var k=f.videoId,l=d;d=f.playerParams;f=f.oj;var m=f8(c),n=e||m.listId;l=l||0;var q={videoId:k,currentIndex:l};g.bJ(m,k,l);g.sa(b)&&(g.$I(m,b),q.currentTime=b);g.sa(n)&&(q.listId=n);null!=d&&(q.playerParams=d);null!=f&&(q.clickTrackingParams=f);j8(c,"setPlaylist",q);e||h8(c,m);H8(a,new g.mR(1))},SAa=function(a,b){if(b){var c=a.R.xc("captions","tracklist",{ay:1});
...
else{a.B=b;var c=a.g.getPlaylistId();var d=a.g.ga(1),e=d.videoId;if(c||e){var f=a.g.Rf();if(f){var k=[];for(var l=0;l<f.getLength();l++)k[l]=f.fc(l).videoId}else k=[e];f=a.g.getCurrentTime(1);c={videoIds:k,listId:c,videoId:e,playerParams:d.playerParams,clickTrackingParams:d.oj,index:Math.max(a.g.kz(),0),currentTime:0==f?void 0:f}}else c=null;o8("Connecting to: "+g.xg(b));"cast-selector-receiver"==b.key?(p8(c||null),$7()?W7().setLaunchParams(c||null):Z7("setLaunchParams called before ready.")):!c&&
...
g.h=pAa.prototype;g.h.Xh=function(a){var b=this.g;if(g.sa(void 0)?0:this.o)b="https://"+this.domain+this.port+this.g;return g.Pg(b+a,{})};
g.h.ku=function(a,b,c,d){c={format:"JSON",method:"POST",context:this,timeout:5E3,withCredentials:!1,Eb:g.Ea(this.LT,c,!0),onError:g.Ea(this.KT,d),sd:g.Ea(this.NT,d)};b&&(c.Ob=b,c.headers={"Content-Type":"application/x-www-form-urlencoded"});return g.tF(a,c)};
...
g.h.lu=function(a,b){if(1==this.g){j8(this,"setAudioTrack",{videoId:a,audioTrackId:b.Oc.id});var c=f8(this);c.audioTrackId=b.Oc.id;h8(this,c)}else g8(this,g.Ea(this.lu,a,b))};
...
g.h.mu=function(a){if((a!=this.g||2==a)&&3!=this.g&&0!=a){var b=this.g;this.g=a;this.U("proxyStateChange",b,a);if(1==a)for(;!this.C.isEmpty();)g.XB(this.C).apply(this);else 3==a&&this.dispose()}};
g.h.zQ=function(a,b){this.U(a,b)};
g.h.iO=function(a){if(!a)this.ol(null),d8(this,null);else if(this.A.receiver.volume){a=this.A.receiver.volume;var b=f8(this),c=Math.round(100*a.level||0);if(b.volume!=c||b.muted!=a.muted)k8("Cast volume update: "+a.level+(a.muted?" muted":"")),b.volume=c,b.muted=!!a.muted,h8(this,b)}};
g.h.ol=function(a){k8("Cast media: "+!!a);this.o&&this.o.removeUpdateListener(this.G);if(this.o=a)this.o.addUpdateListener(this.G),GAa(this),this.U("remotePlayerChange")};
g.h.hO=function(a){a?(GAa(this),this.U("remotePlayerChange")):this.ol(null)};
g.h.vO=function(){var a=AAa();a&&d8(this,a)};
...
var A8=null,y8=null,D8=[],t8=null;g.z(E8,g.L);g.h=E8.prototype;g.h.xH=function(a){this.B=arguments;this.g=!1;this.Aa?this.A=(0,g.D)()+this.sc:this.Aa=g.rg(this.C,this.sc)};
...
g.h.yH=function(){this.A?(this.Aa=g.rg(this.C,this.A-(0,g.D)()),this.A=null):(this.Aa=null,this.o?this.g=!0:(this.g=!1,this.D.apply(null,this.B)))};g.p(F8,g.L);g.h=F8.prototype;
g.h.X=function(){g.L.prototype.X.call(this);this.A.stop();this.B.stop();this.J.stop();this.N();this.g.unsubscribe("proxyStateChange",this.VA,this);this.g.unsubscribe("remotePlayerChange",this.ql,this);this.g.unsubscribe("remoteQueueChange",this.qo,this);this.g.unsubscribe("autoplayUpNext",this.uA,this);this.g.unsubscribe("previousNextChange",this.SA,this);this.g.unsubscribe("nowAutoplaying",this.KA,this);this.g.unsubscribe("autoplayDismissed",this.tA,this);this.g=this.F=null};
g.h.az=function(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(2!=this.g.g)if(I8(this)){if(1081!=f8(this.g).g||"control_seek"!=a)switch(a){case "control_toggle_play_pause":f8(this.g).ib()?this.g.pause():this.g.play();break;case "control_play":this.g.play();break;case "control_pause":this.g.pause();break;case "control_seek":this.I.cj(c[0],c[1]);break;case "control_subtitles_set_track":J8(this,c[0]);break;case "control_set_audio_track":c=c[0],I8(this)&&this.g.lu(this.R.ga(1).videoId,
c)}}else switch(a){case "control_toggle_play_pause":case "control_play":case "control_pause":c=this.R.getCurrentTime();K8(this,0==c?void 0:c);break;case "control_seek":K8(this,c[0]);break;case "control_subtitles_set_track":J8(this,c[0]);break;case "control_set_audio_track":c=c[0],I8(this)&&this.g.lu(this.R.ga(1).videoId,c)}};
g.h.gO=function(a){this.J.xH(a)};
g.h.qT=function(a){this.az("control_subtitles_set_track",g.Yb(a)?null:a)};
g.h.pC=function(){var a=this.R.xc("captions","track");g.Yb(a)||J8(this,a)};
g.h.IA=function(a){if(I8(this)){this.g.unsubscribe("remotePlayerChange",this.ql,this);var b=Math.round(a.volume);a=!!a.muted;var c=f8(this.g);if(b!=c.volume||a!=c.muted)this.g.setVolume(b,a),this.L.start();this.g.subscribe("remotePlayerChange",this.ql,this)}};
g.h.yP=function(){g.Yb(this.C)||SAa(this,this.C);this.D=!1};
g.h.VA=function(a,b){this.B.stop();2==b&&this.lC()};
g.h.ql=function(){if(I8(this)){this.A.stop();var a=f8(this.g);switch(a.g){case 1081:case 1:H8(this,new g.mR(8));this.kC();break;case 1085:case 3:H8(this,new g.mR(9));break;case 0:H8(this,new g.mR(2));this.I.stop();G8(this,this.R.ga().lengthSeconds);break;case 1084:H8(this,new g.mR(4));break;case 2:H8(this,new g.mR(4));G8(this,g.aJ(a));break;case -1:H8(this,new g.mR(64));break;case -1E3:a={errorCode:"mdx.remoteerror",message:g.U("YTP_MDX_PLAYER_ERROR")},H8(this,new g.mR(128,a))}a=f8(this.g).o;var b=
...
g.h.qo=function(){I8(this)||RAa(this)};
g.h.FG=function(){this.g.uw()};
g.h.uA=function(a){a&&(a=g.tF("/watch_queue_ajax",{method:"GET",Xc:{action_get_watch_queue_item:1,video_id:a},Eb:(0,g.y)(this.yR,this)}))&&(this.N=(0,g.y)(a.abort,a))};
g.h.yR=function(a,b){var c=new g.nQ({videoId:b.videoId,title:b.title,author:b.author,murlmq_webp:b.url});this.suggestion=c;this.R.U("mdxautoplayupnext",c)};
g.h.KA=function(a){(0,window.isNaN)(a)||this.R.U("mdxnowautoplaying",a)};
g.h.tA=function(){this.R.U("mdxautoplaycanceled")};
g.h.TK=function(a,b){-1==f8(this.g).g?K8(this,a):b&&this.g.YC(a)};
...
g.h.lC=function(){this.B.stop();this.A.stop();var a=this.g.B.getReconnectTimeout();2==this.g.g&&!(0,window.isNaN)(a)&&this.B.start()};g.p(L8,g.Y);L8.prototype.B=function(a){UAa(this,a.state)};g.p(M8,g.AX);g.h=M8.prototype;g.h.create=function(){QAa(g.pO(g.X(this.g)));this.D.push(g.UG("yt-remote-before-disconnect",this.cO,this));this.D.push(g.UG("yt-remote-connection-change",this.IQ,this));this.D.push(g.UG("yt-remote-receiver-availability-change",this.TA,this));this.D.push(g.UG("yt-remote-auto-connect",this.GQ,this));this.D.push(g.UG("yt-remote-receiver-resumed",this.FQ,this));this.TA()};
g.h.load=function(){this.g.Tp();g.AX.prototype.load.call(this);this.C=new F8(this,this.g,this.o);var a=JAa();a=a?a.currentTime:0;var b=s8()?new e8(r8(),void 0):null;0==a&&b&&(a=g.aJ(f8(b)));0!=a&&(this.I=a||0,this.g.U("progresssync",a,void 0));TAa(this,this.F,this.F);g.K1(this.g.app,6)};
...
g.h.Uk=function(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];this.loaded&&this.C.az.apply(this.C,[].concat([a],g.pa(c)))};
...
g.h.xK=function(){this.o&&this.o.WC()};
g.h.yK=function(){this.o&&this.o.XC()};
